...
import br.com.bthirtyeight.controllers.BookController;
...
public class BookServices {
    ...
    public PagedModel<EntityModel<BookDTO>> findAll(Pageable pageable) {
        ...
        Link findAllink = WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(PersonController.class)
                .findAll(pageable.getPageNumber(), pageable.getPageSize(),
                        String.valueOf(pageable.getSort()))).withSelfRel();

        return assembler.toModel(booksWithLinks, findAllink);
    }
