...
public class CustomEntityResponseHandler extends ResponseEntityExceptionHandler {//sempre extend dessa clase
    ...
    @ExceptionHandler(BadRequestException.class)//define qual tipo de erro esse metodo vai tratar
    ...
    @ExceptionHandler(InvalidJwtAuthenticationException.class)//define qual tipo de erro esse metodo vai tratar
